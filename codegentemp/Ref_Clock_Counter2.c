...
void Ref_Clock_Counter2_Enable(void)
{
    ...
    #if (Ref_Clock_Counter2__QUAD == Ref_Clock_Counter2_CONFIG)
        #if (0u != Ref_Clock_Counter2_QUAD_AUTO_START)
            Ref_Clock_Counter2_TriggerCommand(Ref_Clock_Counter2_MASK, Ref_Clock_Counter2_CMD_RELOAD);
        #endif /* (0u != Ref_Clock_Counter2_QUAD_AUTO_START) */
    #endif  /* (Ref_Clock_Counter2__QUAD == Ref_Clock_Counter2_CONFIG) */
}
...
*   Values:
*     - Ref_Clock_Counter2_CMD_CAPTURE    - Trigger Capture/Switch command
*     - Ref_Clock_Counter2_CMD_RELOAD     - Trigger Reload/Index command
*     - Ref_Clock_Counter2_CMD_STOP       - Trigger Stop/Kill command
*     - Ref_Clock_Counter2_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
